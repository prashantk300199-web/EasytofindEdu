...
import { saveDraft, getDraft, deleteDraft } from "../controllers/hostelDraftController.js";
...
// Public warden inquiry route (no auth required)
router.post("/:id/warden-inquiry", wardenInquiry);
